...
import ua.kaganovych.notes.provider.base.BaseContentProvider;
import ua.kaganovych.notes.provider.notes.NotesColumns;

public class MyNotesProvider extends BaseContentProvider {
    private static final String TAG = MyNotesProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "ua.kaganovych.notes.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return MyNotesDBHelper.getInstance(getContext());
    }
    ...
    protected QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            ...
            case URI_TYPE_NOTE_ID:
                ...
                res.orderBy = NotesColumns.DEFAULT_ORDER;
                break;
